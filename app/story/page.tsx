      ...
      <div className="mx-auto max-w-6xl px-6 py-14 md:py-20">
        <Reveal>
          ...
          <p className="mt-6 max-w-2xl font-sans text-base leading-relaxed text-black/75">
            House of Become is fine jewelry for women in transition — moments of becoming, not arrival.
            We design pieces that honor the quiet decision to choose yourself.
          </p>
        </Reveal>
          ...
          <div className="md:col-span-6">
            <div className="sticky top-24 space-y-6">
              <div className="relative aspect-[16/11] overflow-hidden rounded-3xl bg-black/5">
                <Image src="/images/concept/proposal.png" alt="Concept imagery" fill className="object-cover" />
              </div>
